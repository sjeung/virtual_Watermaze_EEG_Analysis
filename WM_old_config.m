%--------------------------------------------------------------------------
% Configuration for Experiment MWM
%--------------------------------------------------------------------------
% subjects        = [82002 83001];
% studyFolder     = 'P:\Project_Watermaze\Data\'; 
% subjectInfoPath = 'P:\Project_Watermaze\Data\0_raw-data'; 
...
% configuration for function eloc_edit
%--------------------------------------------------------------------------
% elocNewSuffix   = '_edit';
% fiducials       = {'Nasion', 'LeftEar', 'RightEar'};

% table of spatial congifurations used in the experiment 
%--------------------------------------------------------------------------

%--------------------------------------------------------------------------
% Configuration for Bemobil Pipeline 
%--------------------------------------------------------------------------
bemobil_config.study_folder = studyFolder;
...
% Selective cleaning 
bemobil_config.selective_cleaning   = 0; % 0 when not using selective cleaning, 1 when using 
